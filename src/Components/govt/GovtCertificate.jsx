        ...
        <div className="flex justify-between items-start align-top">
          <div className="w-4/5 ">
            <h1 className="mb-4 lg:m-8 text-3xl text-center font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
              2023 - Previously Generated Certificates
            </h1>
          ...
          <div className="border-l-4 border-gray-300 w-1/5 h-auto p-4">
            <Button
              as={Link}
              to={"/govt/company/certificates/generate"}
            ...
            <div className="text-ellipsis py-4">
              <p className="text-sans line-clamp-6 break-words my-4">
                Issuing certificates to companies that have effectively reduced
                their carbon emissions and used fewer carbon credits serves as a
                powerful incentive for sustainable practices.{" "}
              </p>
              <p className="text-sans line-clamp-6 break-words my-4">
                These certificates not only empower companies to sell surplus
                carbon credits, providing an economic advantage, but also
                signify their commitment to environmental responsibility.{" "}
              </p>
              <p className="text-sans line-clamp-6 break-words my-4">
                They become verifiable proof of a company's eco-friendliness,
                making them more attractive to environmentally conscious clients
                and investors. This recognition encourages a culture of emission
                reduction and sustainability, reinforcing the global drive to
                combat climate change while rewarding companies for their

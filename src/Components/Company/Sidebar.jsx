...
import { MdFactory, MdPendingActions, MdAttachMoney } from "react-icons/md";
...
export default function ContentSeparator() {
  return (
    <div className="bg-gray-50">
      <aside
        id="logo-sidebar"
        class="fixed top-0 left-0 h-screen pt-20 transition-transform -translate-x-
      ...
      >
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          <Sidebar aria-label="Sidebar with content separator example">
            <Sidebar.Items>
              <Sidebar.ItemGroup>
                <Sidebar.Item as={Link} to={"/company"} icon={HiChartPie}>
                  <p>Dashboard</p>
                </Sidebar.Item>
                <Sidebar.Item
                  as={Link}
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <p className="px-3 rounded-full  bg-blue-600 text-white">
                      5
                    </p>
                  </div>
                </Sidebar.Item>
                <Sidebar.Item as={Link} to={"/sell"} icon={MdAttachMoney}>
                  <p>Sell Credit</p>
                </Sidebar.Item>
                <Sidebar.Item
                  as={Link}
                ...
                >
                  <div class="grid items-center justify-start  h-24 rounded  dark:bg-gray-800">
                    ...
                    <div className="flex justify-start gap-4 items-center">
                      <HiViewBoards className="text-4xl" />{" "}
